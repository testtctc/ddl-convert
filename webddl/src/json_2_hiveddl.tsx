...
export default class ParserJson extends React.Component<{},JsonRaw> {
  ...
  constructor(props: any) {
    ...
    handleSubmit(event:any) {
      ...
      xhr.onreadystatechange =
          () => {
              if (xhr.readyState == 4 && xhr.status == 200) {
                  var data: JsonRaw = JSON.parse(xhr.responseText) as JsonRaw
                  if (data.code != 200){
      ...
      xhr.open('POST', 'http://localhost:8085/json2ddl');
      xhr.send(out);
